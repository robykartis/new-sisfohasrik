            ...
            <div class="card-body pb-0">
                ...
                <div class="row">
                    <div class="card col-12">
                        <div class="card-header">
                            <h3 class="card-title"><b>Data Rekomendasi</b></h3>
                            <div class="card-tools">
                                <a href="{{ route('rekomendasi.create', $id) }}" class="btn btn-success btn-sm"
                                    title="Add">
                                ...
                                <table class="table table-striped data-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="nowrap text-overflow">Kode Rekomendasi</th>
                                            <th class="nowrap text-overflow">Uraian Rekomendasi</th>
                                            <th class="nowrap text-overflow">Status TLHP</th>
                                            <th class="nowrap text-overflow">Kode TLHP</th>
                                            <th class="nowrap text-overflow">Uraian TLHP</th>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('rekomendasi.index', $request->id) }}",
                    type: "GET",
                },
