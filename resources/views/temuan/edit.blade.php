                    ...
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="judul_temuan" placeholder="Masukan Judul Temuan" class="form-control">{{ $temuan->judul_temuan }}</textarea>
                                @error('judul_temuan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control mask-money"
                                        value="{{ $temuan->jml_rnd_neg }}" name="jml_rnd_neg">
                                    @error('jml_rnd_neg')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control mask-money"
                                        value="{{ $temuan->jml_snd_neg }}" name="jml_snd_neg">
                                    @error('jml_snd_neg')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control mask-money"
                                        value="{{ $temuan->jml_rnd_neg }}" name="jml_rnd_drh">
                                    @error('jml_rnd_neg')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control mask-money"
                                        value="{{ $temuan->jml_snd_neg }}" name="jml_snd_drh">
                                    @error('jml_snd_neg')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="keterangan" placeholder="Masukan Keterangan" class="form-control">{{ $temuan->keterangan }}</textarea>
                                @error('keterangan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
