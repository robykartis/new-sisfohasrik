    ...
    <section class="content">
        ...
        <div class="card card-warning">
            <div class="card-header ">
                <h3 class="card-title">Tindak Lanjut Hasil Pemeriksaan</h3>
            </div>
            <div class="card-body pb-0">
                ...
                <div class="row">
                    <div class="card col-12">
                        <div class="card-header">
                            <h3 class="card-title"><b>Data Tindak Lanjut</b></h3>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped data-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="nowrap text-overflow" style="width: 10%">Kode Rekomendasi</th>
                                            <th class="nowrap text-overflow" style="width: 30%">Uraian Rekomendasi</th>
                                            <th class="nowrap text-overflow" style="width: 15%">Status TLHP</th>
                                            <th class="nowrap text-overflow" style="width: 10%">Kode TLHP</th>
                                            <th class="nowrap text-overflow" style="width: 30%">Uraian TLHP</th>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('tindaklanjut.index', $request->id) }}",
                    type: "GET",
                },
                ...
                columns: [{
                    ...
                    {
                        data: 'kod_rekomendasi',
                        name: 'kod_rekomendasi',
                        createdCell: function(td, cellData, rowData, row, col) {
                            $(td).css('word-break', 'break-all');
                        }
                    },
