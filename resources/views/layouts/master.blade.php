...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin/vendor/bootstrap-icons/font/bootstrap-icons.css') }}">

    <!-- CSS Front Template -->

    <link rel="preload" href="{{ asset('admin/css/theme.min.cs') }}s" data-hs-appearance="default" as="style">
    <link rel="preload" href="{{ asset('admin/css/theme-dark.min.css') }}" data-hs-appearance="dark" as="style">
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <script src="{{ asset('admin/vendor/jquery-migrate/dist/jquery-migrate.min.js') }}"></script>
    <script src="{{ asset('admin/vendor/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>

    <!-- JS Implementing Plugins -->
    <script src="{{ asset('admin/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside.min.js') }}"></script>
    <script src="{{ asset('admin/vendor/hs-form-search/dist/hs-form-search.min.js') }}"></script>
